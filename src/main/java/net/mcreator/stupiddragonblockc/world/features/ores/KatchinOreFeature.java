...
package net.mcreator.stupiddragonblockc.world.features.ores;
...
public class KatchinOreFeature extends OreFeature {
	public static KatchinOreFeature FEATURE = null;
