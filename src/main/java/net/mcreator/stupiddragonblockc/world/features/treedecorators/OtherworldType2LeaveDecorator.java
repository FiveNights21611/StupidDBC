...
public class OtherworldType2LeaveDecorator extends LeaveVineDecorator {
	public static final OtherworldType2LeaveDecorator INSTANCE = new OtherworldType2LeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("otherworld_type_2_tree_leave_decorator", tdt);
	}

	public OtherworldType2LeaveDecorator() {
		super(0.25f);
	}
