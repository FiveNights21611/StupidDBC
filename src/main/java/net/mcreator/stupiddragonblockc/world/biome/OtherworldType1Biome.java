...
public class OtherworldType1Biome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-205).waterColor(-14604365).waterFogColor(-14802042).skyColor(-205).foliageColorOverride(-13609672).grassColorOverride(-13667010).build();
		BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder();
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("stupid_dbc:tree_otherworld_type_1",
						FeatureUtils.register("stupid_dbc:tree_otherworld_type_1", Feature.TREE,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("stupid_dbc:grass_otherworld_type_1", VegetationFeatures.PATCH_GRASS,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("stupid_dbc:flower_otherworld_type_1", VegetationFeatures.FLOWER_DEFAULT,
