...
import net.mcreator.stupiddragonblockc.procedures.LetGoOfTransformProcedure;
import net.mcreator.stupiddragonblockc.procedures.DoTransformationProcedure;
...
public class TransformMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			DoTransformationProcedure.execute(entity);
		}
		if (type == 1) {

			LetGoOfTransformProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		StupidDbcMod.addNetworkMessage(TransformMessage.class, TransformMessage::buffer, TransformMessage::new, TransformMessage::handler);
	}
}
