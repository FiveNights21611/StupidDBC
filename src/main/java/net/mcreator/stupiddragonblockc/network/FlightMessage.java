...
import net.mcreator.stupiddragonblockc.procedures.FlightDoProcedure;
...
public class FlightMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 1) {
			...
			FlightDoProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		StupidDbcMod.addNetworkMessage(FlightMessage.class, FlightMessage::buffer, FlightMessage::new, FlightMessage::handler);
	}
}
