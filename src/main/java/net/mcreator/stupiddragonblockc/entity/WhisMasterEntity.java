...
public class WhisMasterEntity extends PathfinderMob {
	public WhisMasterEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StupidDbcModEntities.WHIS_MASTER.get(), world);
	}
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(WhisMasterEntity.this.getId());
					return new WhisMasterMenuMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
