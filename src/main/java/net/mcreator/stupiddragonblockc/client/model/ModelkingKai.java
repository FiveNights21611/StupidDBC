...
public class ModelkingKai<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("stupid_dbc", "modelking_kai"), "main");
	public final ModelPart bb_main;

	public ModelkingKai(ModelPart root) {
