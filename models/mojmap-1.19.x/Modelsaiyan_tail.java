...
public class Modelsaiyan_tail<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition TailPart1 = Tail.addOrReplaceChild("TailPart1", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition TailPart1_r1 = TailPart1
				.addOrReplaceChild("TailPart1_r1",
						CubeListBuilder.create().texOffs(32, 32).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 6.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6981F, 0.0F, 0.0F));

		PartDefinition TailPart2 = TailPart1.addOrReplaceChild("TailPart2", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 6.0F));

		PartDefinition TailPart2_r1 = TailPart2.addOrReplaceChild("TailPart2_r1",
				CubeListBuilder.create().texOffs(32, 32).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 3.625F, -2.3125F, 0.2618F, 0.0F, 0.0F));

		PartDefinition TailPart3 = TailPart2.addOrReplaceChild("TailPart3", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 6.0F));

		PartDefinition TailPart3_r1 = TailPart3.addOrReplaceChild("TailPart3_r1",
				CubeListBuilder.create().texOffs(32, 32).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 2.4375F, -3.0625F, 0.9599F, 0.0F, 0.0F));

		PartDefinition TailPart4 = TailPart3.addOrReplaceChild("TailPart4", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 6.0F));

		PartDefinition TailPart4_r1 = TailPart4.addOrReplaceChild("TailPart4_r1",
				CubeListBuilder.create().texOffs(32, 32).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
